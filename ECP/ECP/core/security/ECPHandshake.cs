...
namespace ECP.API.Security
{
    ...
    /// </summary>
    public class ECPHandshake : IDisposable
    {
        #region - Util -
        ...
        /// </summary>
        /// <returns></returns>
        public ECPHandshake GenerateRequest()
        {
        ...
        /// <returns></returns>
        public ECPHandshake GenerateResponse(string request)
        {
